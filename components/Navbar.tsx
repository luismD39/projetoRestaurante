    ...
    return(
        ...
        <header className="w-full bg-white border-b shadow-sm">
            <nav className="max-w-7x1 mx-auto px-8 py-4 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-2 text-2x1 font-bold text-green-600">
                Restaurante
                ...
                <div className="flex items-center gap-8">
                    ...
                    <Link href="/cardapio" className="text-gray-700 hover:text-green-600 transition">  
                    Cardápio
                    </Link>
